...
var _emojiToolkit = require("emoji-toolkit");

var _emojiToolkit2 = _interopRequireDefault(_emojiToolkit);
...
var _emoji = require("emoji-toolkit/emoji.json");
...
var Picker = function (_Component) {
  ...
  function Picker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Picker.__proto__ || Object.getPrototypeOf(Picker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.addToFrequentlyUsed(data);
  ...
  _createClass(Picker, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _each2.default)(this.props.emojione, function (value, key) {
        _emojiToolkit2.default[key] = value;
      });
    ...
    value: function getFromFrequentlyUsed(strategy, frequentlyUsed) {
      ...
      var x = 0;
      frequentlyUsed.reverse().forEach(function (frequentlyUsed) {
    ...
    value: function addToFrequentlyUsed(data) {
      var strategyName = data.shortname.replace(/:/g, '');
      ...
      var newFrequentlyUsed = [].concat(_toConsumableArray(currentFrequentlyUsed.filter(function (f) {
        return f.shortname !== data.shortname;
      })), [data]);
      ...
      this.setState({
        ...
        emojis: _extends({}, this.state.emojis, this.getFromFrequentlyUsed(strategyName, newFrequentlyUsed))
      });
    }
  }, {
    key: "render",
