...
var Emoji = function (_Component) {
  ...
  function Emoji() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Emoji.__proto__ || Object.getPrototypeOf(Emoji)).call.apply(_ref, [this].concat(args))), _this), _this._handleKeyUp = function (ev) {
      ...
      _this.props.onSelect(ev, (0, _pick2.default)(_this.props, "shortname", "aliases", "ascii", "category", "name", "order", "shortcode", "code_points", "unicode_version", "keywords"));
  ...
  _createClass(Emoji, [{
    ...
    value: function createMarkup() {
      return { __html: _emojiToolkit2.default.shortnameToImage(this.props.shortname) };
    }
  }, {
    key: "render",
